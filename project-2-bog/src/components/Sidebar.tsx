...
// const Sidebar: React.FC<SidebarProps> = ({ fullName, email }) => {
...
//           {fullName.charAt(0)} {/* Display first letter of full name */}
//         </div>
//         <div>
//           <p>{fullName}</p> {/* Display full name */}
//           <p className="text-sm text-gray-400">{email}</p> {/* Display email */}
//         </div>
//       </div>
//     </div>
//   );
